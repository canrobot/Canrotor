...
//    AHRSIMU->Yaw   = atan2(2.0f * (AHRSIMU->_q1 * AHRSIMU->_q2 + AHRSIMU->_q0 * AHRSIMU->_q3), AHRSIMU->_q0 * AHRSIMU->_q0 + AHRSIMU->_q1 * AHRSIMU->_q1 - AHRSIMU->_q2 * AHRSIMU->_q2 - AHRSIMU->_q3 * AHRSIMU->_q3);
//    AHRSIMU->Pitch = -asin(2.0f * (AHRSIMU->_q1 * AHRSIMU->_q3 - AHRSIMU->_q0 * AHRSIMU->_q2));
//    AHRSIMU->Roll  = atan2(2.0f * (AHRSIMU->_q0 * AHRSIMU->_q1 + AHRSIMU->_q2 * AHRSIMU->_q3), AHRSIMU->_q0 * AHRSIMU->_q0 - AHRSIMU->_q1 * AHRSIMU->_q1 - AHRSIMU->_q2 * AHRSIMU->_q2 + AHRSIMU->_q3 * AHRSIMU->_q3);
//    AHRSIMU->Pitch *= R2D;
//    AHRSIMU->Yaw   *= R2D;
//    AHRSIMU->Yaw   -= 8.7; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
//    AHRSIMU->Roll  *= R2D;
}
